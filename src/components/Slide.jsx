...
// import { bgSlider } from "../utils"; // Your images

// const ImageCarousel = () => {
//   const [currentIndex, setCurrentIndex] = useState(0);
//   const carouselRef = useRef(null); // Ref for the slider

//   const images = [bgSlider, "image2.jpg", "image3.jpg"]; // Your images array
...
//   // ✅ Use GSAP to smoothly transition slides
//   useEffect(() => {
//     if (carouselRef.current) {
//       gsap.to(carouselRef.current, {
//         x: `-${currentIndex * 100}%`, // Moves the images left
